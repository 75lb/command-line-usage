 ...
 * @property raw {boolean} - Set to true to avoid indentation and wrapping. 
 * @example
 * {
 ...
 */
  ...
  * @property [group] {string|string[]} - If specified, only options from this particular group will be printed.
  * @property [hide] {string|string[]} - The names of one of more option definitions to hide from the option list.
  *
  * @example
  * {
  *   header: 'Options',
