...
class Content extends Section {
   ...
   * @param [section.header] {string} - The section header.
   * @param section.content {string|string[]|object[]} - One or more lines of text. Pass a recordset array for tabulated content.
   */
  constructor (section) {
    super()
